...
function generateWeeklyReport() {
  ...
  // Generate insight text once — used in both .txt and .json
  const insight = generateInsight(avgFailureRate, criticalBlocks, topContracts);
  ...
  try {
    ...
    // Save JSON version for dashboard — includes insight field
