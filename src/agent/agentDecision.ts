// ── Decision thresholds ───────────────────────────────────────
const THRESHOLDS = {
  HEALTH_SCORE_BUY_CONTRACT_SCAN: 85,   // fires when health score drops to 85 or below 
  FAILURE_RATE_BUY_BLOCK_ANALYSIS: 0.03, // fires at 3% failure rate
  FAILURE_RATE_CRITICAL: 0.10,           // critical at 10% failure rate
